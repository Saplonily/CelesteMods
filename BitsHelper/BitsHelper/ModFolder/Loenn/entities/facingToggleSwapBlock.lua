...
swapBlock.name = "BitsHelper/FacingToggleSwapBlock"
...
function swapBlock.sprite(room, entity)
    ...
    addTrailSprites(sprites, entity, "objects/swapblock/target", false)
    addBlockSprites(sprites, entity, entity, "objects/BitsHelper/facingSwap/blockRed", "objects/swapblock/moon/midBlockRed00")
...
function swapBlock.nodeSprite(room, entity, node)
    ...
    addBlockSprites(sprites, entity, node, "objects/BitsHelper/facingSwap/blockRed", "objects/swapblock/moon/midBlockRed00", true)
